...
# Parse arguments
parser = argparse.ArgumentParser(description='PyTorch Fast ImageNet Training')
...
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='ws_resnet50', help='model architecture')
# Miscs
