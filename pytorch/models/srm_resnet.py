...
__all__ = ['srm_resnet34', 'srm_resnet50', 'srm_resnet101']
...
def resnet34(num_classes=1000):
    model = ResNet(basic_block_factory(), [3, 4, 6, 3], num_classes=num_classes)
...
def srm_resnet34(num_classes=1000):
    model = ResNet(basic_block_factory(layer_block=SRMLayer), [3, 4, 6, 3], num_classes=num_classes)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
def resnet50(num_classes=1000):
    model = ResNet(bottleneck_factory(), [3, 4, 6, 3], num_classes=num_classes)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
def srm_resnet50(num_classes=1000):
    model = ResNet(bottleneck_factory(layer_block=SRMLayer), [3, 4, 6, 3], num_classes=num_classes)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
def resnet101(num_classes=1000):
    model = ResNet(bottleneck_factory(), [3, 4, 23, 3], num_classes=num_classes)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model


def srm_resnet101(num_classes=1000):
    model = ResNet(bottleneck_factory(layer_block=SRMLayer), [3, 4, 23, 3], num_classes=num_classes)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
