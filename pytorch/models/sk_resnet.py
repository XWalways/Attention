...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv2 = conv3x3(planes, planes, groups=32)
        self.bn2 = nn.BatchNorm2d(planes)
        
        self.conv2g = nn.Conv2d(planes, planes, stride=1, kernel_size=3, dilation=2, padding=2, groups=32, bias=False) #conv3x3(planes, planes, stride, groups = 32), maybe is wrong
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv2 = conv3x3(planes, planes, stride, groups=32)
        self.bn2 = nn.BatchNorm2d(planes)
        self.conv2g = nn.Conv2d(planes, planes, stride=stride, kernel_size=3, dilation=2, padding=2, groups=32, bias=False) #conv3x3(planes, planes, stride, groups = 32), maybe is wrong
        self.bn2g   = nn.BatchNorm2d(planes)
